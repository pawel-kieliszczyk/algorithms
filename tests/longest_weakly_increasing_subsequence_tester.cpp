...
TEST_F(longest_weakly_increasing_subsequence_tester, tests_sequence_of_all_weakly_decreasing_elements)
{
    // given
    std::vector<int> numbers;
    numbers.push_back(33);
    ...
    // when and then
    EXPECT_EQ(2, lms::weakly_increasing(numbers.begin(), numbers.end()));
}
...
TEST_F(longest_weakly_increasing_subsequence_tester, tests_sequence_of_floatoing_point_elements)
{
    // given
    ...
    // when and then
    EXPECT_EQ(8, lms::weakly_increasing(numbers.begin(), numbers.end()));
}
