...
source_files += ['tests/geometry/point_on_segment_tester.cpp']
source_files += ['tests/geometry/points_collinear_tester.cpp']
source_files += ['tests/geometry/segment_tester.cpp']
source_files += ['tests/geometry/segments_overlapping_tester.cpp']
